...
class MyRobot(wpilib.IterativeRobot):
    ...
    def autonomousPeriodic(self):
        ...
        self.sd.putNumber('EC1',self.EC1)
        self.sd.putNumber('EC2',self.EC2)
        self.sd.putNumber('EC3',self.EC3)
        self.sd.putNumber('EC4',self.EC4)
	...
	#Powercube collector - "Golden Arrowhead"
        ...
        self.sd.putNumber('SV1',self.SV1)
        self.sd.putNumber('SV2',self.SV2)
